...
const serviceCategories = [
  ...
  },
  {
    ...
    icon: CreditCard,
    title: "Operatività Bancaria & Servizi Complementari",
    desc: "Soluzioni assicurative, bancarie e di credito per una tutela a 360 gradi per la clientela di Cremona e provincia."
  },
];
